...
function App() {
  ...
  const filteredHandler = () => {
    switch (status) {
      case "completed":
        setFilteredData(todoItems.filter((data) => data.completed === true));
        break;
      case "uncompleted":
        setFilteredData(
          todoItems.filter((data) => data.completed === false)
        );
        break;
    ...
    <div className="App">
      ...
      <div className="cards-container">
        ...
        <ToDoCard
          ...
          todoItems={todoItems}
          setTodoItems={setTodoItems}
          filteredData={filteredData.filter((data) => data.completed)}
          onTaskEdit={setInputText}
          setDescription={setDescription}
          setDueDate={setDueDate}
          setPriority={setPriority}
